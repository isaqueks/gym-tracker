    ...
    <div className="min-h-screen bg-dark-900 flex flex-col justify-center px-6 py-12">
      <div className="mx-auto w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-dark-400 mt-1">Comece a treinar hoje</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-dark-300">Nome</label>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-dark-500">Mínimo de 6 caracteres</p>
          </div>
